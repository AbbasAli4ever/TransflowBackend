...
export interface components {
    schemas: {
        ...
        VersionResponseDto: {
            ...
            buildDate?: Record<string, never>;
            /** @example a1b2c3d4 */
            gitCommit?: Record<string, never>;
        };
        CreateSupplierDto: {
        ...
        SupplierComputedDto: {
            ...
            /** @example null */
            lastPurchaseDate: Record<string, never> | null;
        };
        SupplierResponseDto: {
        ...
        CustomerComputedDto: {
            ...
            currentBalance: number;
            /** @example null */
            lastSaleDate: Record<string, never> | null;
        };
        CustomerResponseDto: {
            /** @example 9f4b6e2c-0a2d-4cc5-8c4d-1a4a88c81a88 */
            id: string;
        ...
        PaymentAccountComputedDto: {
            ...
            totalOut: number;
            /** @example null */
            lastTransactionDate: Record<string, never> | null;
        };
        ...
        TransactionResponseDto: {
            ...
            totalAmount: number;
            /** @example DELIVERY */
            deliveryType?: Record<string, never>;
    ...
    TransactionsController_findAll: {
        parameters: {
            query?: {
                page?: number;
                limit?: number;
                type?: "PURCHASE" | "SALE" | "RETURN" | "TRANSFER";
